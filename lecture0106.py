...
# exercise 2:
# Write a function evenNums(), which prompts a message "Enter a whole number: " to the user to get a number n and
# prints out even numbers from 0 until n
...
# The function prompt a message "Enter a whole number: ", get a number n from the user then print out either even
# numbers or odd numbers until n
...
# login(l) takes a list l consists of strings or names, prompts a message to 'Enter your login id: ' to the user
# and get a login id from the user, then it check whether the login id is within the list l
def login(l):
